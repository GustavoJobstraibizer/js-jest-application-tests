...
describe('Cart', () => {
  ...
  describe('checkout()', () => {
    it('should return an object whith the total and the list of items', () => {
      cart.add({
        product,
        quantity: 2,
      });
    ...
    it('should return an object whith the total and the list of items when sumary() is called', () => {
      cart.add({
        product,
        quantity: 2,
      });
  ...
  describe('special conditions', () => {
    ...
    it('should NOT apply percentage discount quantity is below or equal to minimum', () => {
      const condition = {
        percentage: 30,
        minimum: 2,
      };
    ...
    it('should receive two or more conditions and determine/apply the discount. First case', () => {
      const condition1 = {
        percentage: 30,
        minimum: 2,
      };
    ...
    it('should receive two or more conditions and determine/apply the discount. Second case', () => {
      const condition1 = {
        percentage: 80,
        minimum: 2,
      };
